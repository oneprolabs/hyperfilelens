...
![Create Backup Policy showing quick schedule, retention, and error-handling preview with the personal account blurred](/docs/en/backup-restore/backup-policy-editor.png)
...
![Create File Filter showing quick presets and the custom exclusion editor with the personal account blurred](/docs/en/backup-restore/file-filter-editor.png)
