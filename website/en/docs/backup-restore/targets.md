...
![Object-storage provider selection in Add Repository with account information blurred](/docs/en/getting-started/select-huawei-cloud.png)
...
![Huawei Cloud OBS repository form with account, bucket, object prefix, and credentials redacted while public endpoint, region, and SSL settings remain visible](/docs/en/getting-started/configure-huawei-repository.png)
...
![Created Huawei Cloud OBS repository with Connectivity Online and account, repository name, bucket, and object prefix blurred](/docs/en/getting-started/huawei-repository-created.png)
