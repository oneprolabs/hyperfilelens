...
const taskEventMessageKeys: Record<string, string> = {
  ...
  'direct nas repository cleanup failed.': 'ops.task.eventMessage.directNasRepositoryCleanupFailed',
  'direct nas repository cleanup was blocked.': 'ops.task.eventMessage.directNasRepositoryCleanupBlocked',
  ...
  'backup configuration reset deferred until endpoint cleanup completes': 'ops.task.eventMessage.backupConfigurationResetDeferred',
  'cleaning up source endpoints': 'ops.task.eventMessage.cleaningUpSourceEndpoints',
  'source endpoint cleanup completed': 'ops.task.eventMessage.sourceEndpointCleanupCompleted',
  'source endpoint cleanup completed with retained resources': 'ops.task.eventMessage.sourceEndpointCleanupCompletedWithRetained',
  'source endpoint cleanup dispatched': 'ops.task.eventMessage.sourceEndpointCleanupDispatched',
  'waiting for direct nas repository cleanup': 'ops.task.eventMessage.waitingForDirectNasRepositoryCleanup',
  'waiting for backup snapshot cleanup': 'ops.task.eventMessage.waitingForBackupSnapshotCleanup',
  'waiting for agent uninstall completion': 'ops.task.eventMessage.waitingForAgentUninstallCompletion',
  'agent uninstall could not be started.': 'ops.task.eventMessage.agentUninstallCouldNotBeStarted',
  'agent uninstall failed.': 'ops.task.eventMessage.agentUninstallFailed',
  ...
  'source deregistration is in progress.': 'ops.task.eventMessage.sourceUnregisterInProgress',
  'source deregistration prepared for retry': 'ops.task.eventMessage.sourceUnregisterPreparedForRetry',
  'no backup source deregistration was accepted.': 'ops.task.eventMessage.noSourceUnregisterAccepted',
  'no backup sources were specified.': 'ops.task.eventMessage.noBackupSourcesSpecified',
  'synchronous source deregistration accepts one source at a time.': 'ops.task.eventMessage.synchronousSourceUnregisterOneAtATime',
  ...
  'backup queue recovery re-enqueued the original task': 'ops.task.eventMessage.backupQueueRecoveryReenqueued',
}
