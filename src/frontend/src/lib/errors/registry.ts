...
export const ERROR_CODE_FALLBACK_EN: Record<string, string> = {
  ...
  'AGENT.PATH_PERMISSION_DENIED': 'The Agent does not have permission to access this path. Choose a readable path or use System Service mode when broader host access is required.',
