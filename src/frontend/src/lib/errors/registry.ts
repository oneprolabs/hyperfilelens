...
export const ERROR_CODE_FALLBACK_EN: Record<string, string> = {
  ...
  'AGENT.UPGRADE_REQUIRED': 'Upgrade the selected Agent before adding the current files and folders.',
  ...
  'AGENT.EXPLORER_CAPTURE_FAILED': 'Unable to add the current contents. Check path access and make sure the selected scope contains no more than 10,000 files and folders.',
