...
describe('repository residual status UI', () => {
  ...
  it('labels unused connectivity clearly and provides a hover explanation', () => {
    ...
    expect(en.repositoriesPage.healthBoundUnverifiedSmbHelp).toContain('Proxy is online')
    expect(en.repositoriesPage.healthBoundUnverifiedNfsHelp).toContain('NFS repository')
    expect(en.repositoriesPage.healthBoundUnverifiedGenericHelp).toContain('this repository')
    ...
    expect(zhHans.repositoriesPage.healthBoundUnverifiedSmbHelp).not.toBe(en.repositoriesPage.healthBoundUnverifiedSmbHelp)
